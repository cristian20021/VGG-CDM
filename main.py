...
if __name__ == "__main__":
    ...
    while True:
        ...
        choice = int( input( '\nWhat type of file would you like to process? (1 for images, 2 for videos, 3 for benchmarks, 0 for exit)\n' ) )
        ...
        if choice == 1:    
            try:
                ...
                print("\n!!!Source image or reference image was not found. Try again.!!!")
            ...
            try:
                ...
                print( "\n!!!Source video or reference image was not found. Try again.!!!" )
            ...
            print( '\n!!!Please choose a number from 0-3.!!!' )